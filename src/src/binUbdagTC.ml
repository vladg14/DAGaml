...
struct
	...
	let makeman man eva hsize =
		...
		mem.MemoBTable.err <- (fun x opa opaa opb opbb ->
			...
			print_newline();
			print_string "opa  :";
			print_string (StrDump.option M.M.M.M.G.strdump_node' opa);
			print_newline();
			print_string "opaa :";
			print_string StrDump.(option bitv_hexa opaa);
			print_newline();
			print_string "opb  :";
			print_string (StrDump.option M.M.M.M.G.strdump_edge' opb);
			print_newline();
			print_string "opbb :";
			print_string StrDump.(option bitv_hexa opbb);
			print_newline();
		...
		(* mem.MemoBTable.each <- (fun a aa b bb ->
			print_string "##";
			print_string (StrDump.bitv_hexa aa);
			print_string " ";
			print_string (StrDump.bitv_hexa bb);
			print_newline()
		); *)
...
struct
    ...
    let newman man solver = makeman man solver default_newman_hsize
